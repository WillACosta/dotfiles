...
alias gps='git push'
alias gb='git branch'
alias gbm='git branch -m' # rename a local branch

alias c='clear'

## Docker
alias dcps='docker compose ps'
alias dcsall='docker compose stop $(docker ps -q)'
...
test -f ~/.stk/bin/.bashrc && . ~/.stk/bin/.bashrc

## Start dev tmux session
~/workspace/projects/others/dotfiles/start_dev.sh